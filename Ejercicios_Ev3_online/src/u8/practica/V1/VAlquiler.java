...
public class VAlquiler extends JDialog implements ActionListener {
	private static final int WINDOW_WIDTH = 300;
	private static final int WINDOW_HEIGHT = 150;
	private static final String WINDOW_TITLE = "Opción alquiler de producto.";
	...
	public VAlquiler(VPrincipal parent, boolean modal) {
		super(parent, modal);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (codigoCorrecto) {
			ProductoVideoclub.alquilar(codigo);
			campoCodigo.setText("");
		}
